...
class CalculateChecksumTest {
    ...
    @Test
    fun testRealQuestion() {
        val input = "86\t440\t233\t83\t393\t420\t228\t491\t159\t13\t110\t135\t97\t238\t92\t396\n" +
        ...
        asserter.assertEquals("Checksum from example should be 45158", 45158, checksum)
    }
    ...
    fun testRealQuestionPart2() {
        ...
        asserter.assertEquals("Checksum from example should be 294", 294, checksum)
    }
}